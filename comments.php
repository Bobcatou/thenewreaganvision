...
<?php if ( have_comments() ) : ?>
	...
	<h2 class="comments"><?php comments_number( __('No Comments', 'wpzoom'), __('1 Comment', 'wpzoom'), __('% Comments', 'wpzoom')); ?></h2>
	...
	<?php else : // comments are closed ?><!-- If comments are closed. -->
		...
		<!--<h2 class="comments"><?php _e('Comments are closed', 'wpzoom'); ?></h2>-->
...
<?php if ('open' == $post->comment_status) : ?>
	...
	<div id="respond">
		...
		<h2 class="comments"><?php comment_form_title( __('Leave a reply', 'wpzoom' ), __('Leave a reply to %s', 'wpzoom')); ?></h2>
