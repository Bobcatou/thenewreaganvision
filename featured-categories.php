...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Sidebar: Lower Content') ) : ?> <?php endif; ?>


</div><!-- end #lowerContent --> 


<div id="lowerContent-right">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Sidebar: Lower Content-Right') ) : ?> <?php endif; ?>
</div><!-- end #lowerContent-Right --> 
